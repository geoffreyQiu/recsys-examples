...
if __name__ == "__main__":
    model_config, cache_config = get_config(str(PACKAGE_ROOT / "test" / "x_test_config.yml"))
    ...
    uids = torch.tensor([100], dtype=torch.int64)
    x = torch.ops.kvcache_manager_ops.lookup(tokens, uids)
    print(x)