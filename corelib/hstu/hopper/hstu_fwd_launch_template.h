...
void run_hstu_fwd(Hstu_fwd_params &params, cudaStream_t stream) {
  ...
  typename CollectiveMainloop::Params mainloop_params =
      CollectiveMainloop::to_underlying_arguments({
          ...
          params.target_group_size, params.scaling_seqlen, params.alpha, 
          params.cu_seqlens_vt_descale, params.cu_seqlens_q_block_descale, params.cu_seqlens_kv_block_descale, params.q_block_descale_head_stride, params.kv_block_descale_head_stride
      });
